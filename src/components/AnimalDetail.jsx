    ...
    <div className="modal-overlay" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal">
        ...
        <div className="detail-hero">
          {/* Foto o emoji según haya imagen */}
          <div className="detail-avatar" style={{ overflow: "hidden" }}>
            {animal.foto_url
              ? <img src={animal.foto_url} alt={animal.nombre || "animal"} style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              : (animal.especie === "gato" ? "🐱" : animal.especie === "perro" ? "🐶" : "🐾")
            }
          </div>
        ...
        <div className="grid-2" style={{ gap: 12, marginBottom: 14 }}>
          {[
            ...
            ["📅 Aparición",  animal.fecha],
            ["✂️ Castrado",   animal.castrado],
            ["🏥 Salud",      animal.salud],
            ["👤 Responsable",animal.responsable],
          ].map(([k, v]) => (
